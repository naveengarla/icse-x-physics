...
```mermaid
graph TD
    A["🔍 Is the body in EQUILIBRIUM?"]
    A --> B{"Net Force\n∑F = 0?"}
    B -->|"YES"| C{"Net Moment\n∑τ = 0?"}
    B -->|"NO"| X["❌ NOT in Equilibrium\nBody is accelerating linearly"]
    C -->|"YES"| D{"Is body\nmoving?"}
    C -->|"NO"| Y["❌ NOT in Equilibrium\nBody is rotating/spinning"]
    D -->|"NO"| E["✅ STATIC EQUILIBRIUM\nBody at rest"]
    D -->|"YES (constant velocity)"| F["✅ DYNAMIC EQUILIBRIUM\nBody moving at constant velocity"]

    style A fill:#1a1a2e,color:#eee,stroke:#7c83fd
    style B fill:#16213e,color:#eee,stroke:#7c83fd
    style C fill:#16213e,color:#eee,stroke:#7c83fd
    style D fill:#16213e,color:#eee,stroke:#7c83fd
    style E fill:#1b4332,color:#eee,stroke:#52b788
    style F fill:#0f3460,color:#eee,stroke:#00b4d8
    style X fill:#3d0000,color:#eee,stroke:#e94560
    style Y fill:#3d0000,color:#eee,stroke:#e94560
```
